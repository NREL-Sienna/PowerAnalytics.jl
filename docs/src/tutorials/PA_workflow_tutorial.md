...
2) Calculate the active power for the corresponding generators of this type using one of PowerAnalytics's defined metrics, namely `calc_active_power`, which retrieves the generation time series from the results. 
